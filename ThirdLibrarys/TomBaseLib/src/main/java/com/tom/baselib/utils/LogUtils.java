...
public class LogUtils {
    ...
    public static void log(final int type, final String tag, final Object... contents) {
        boolean isLog = !CONFIG.mLogSwitch || (!CONFIG.mLog2ConsoleSwitch && !CONFIG.mLog2FileSwitch);
        if (isLog) {
            return;
        }
        ...
        boolean isLogFile = (CONFIG.mLog2FileSwitch || type_high == FILE) && type_low >= CONFIG.mFileFilter;
        if (isLogFile) {
