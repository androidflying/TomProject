...
import com.tom.kalle.exception.DownloadError;
...
import com.tom.kalle.util.UrlUtils;
...
import static com.tom.kalle.http.Headers.KEY_RANGE;
...
public abstract class BasicWorker<T extends Download> implements Callable<String> {
    ...
    private String getRealFileName(Headers headers) {
