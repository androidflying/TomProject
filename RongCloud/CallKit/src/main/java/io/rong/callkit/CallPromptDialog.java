...
public class CallPromptDialog extends AlertDialog {
    ...
    protected void onStart() {
        ...
        TextView txtViewTitle = view.findViewById(io.rong.imkit.R.id.popup_dialog_title);
        TextView txtViewMessage = view.findViewById(io.rong.imkit.R.id.popup_dialog_message);
        TextView txtViewOK = view.findViewById(io.rong.imkit.R.id.popup_dialog_button_ok);
        TextView txtViewCancel = view.findViewById(io.rong.imkit.R.id.popup_dialog_button_cancel);
