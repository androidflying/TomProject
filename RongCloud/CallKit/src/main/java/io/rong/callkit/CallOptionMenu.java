...
public class CallOptionMenu extends PopupWindow {
    ...
    public CallOptionMenu(Context context) {
        ...
        layoutAdd = content.findViewById(R.id.voipItemAdd);
        ...
        layoutWhiteBoard = content.findViewById(R.id.voipItemWhiteboard);
        ...
        layoutHandUp = content.findViewById(R.id.voipItemHandup);
