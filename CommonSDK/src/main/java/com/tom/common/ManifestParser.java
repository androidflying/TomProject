...
public final class ManifestParser {
    ...
    public List<ApplicationImpl> parse() {
        List<ApplicationImpl> modules = new ArrayList();
        try {
    ...
    private static ApplicationImpl parseModule(String className) {
        Class<?> clazz;
        try {
